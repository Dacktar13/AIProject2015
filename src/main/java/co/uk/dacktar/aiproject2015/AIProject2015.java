...
import co.uk.dacktar.neuralNetwork.KohonenNetwork;
import co.uk.dacktar.neuralNetwork.NeuralReportable;
import co.uk.dacktar.neuralNetwork.Sample;
import co.uk.dacktar.neuralNetwork.SampleData;
import co.uk.dacktar.neuralNetwork.TrainingSet;
...
public class AIProject2015 extends JFrame implements Runnable,NeuralReportable {
  ...
  void load_actionPerformed(java.awt.event.ActionEvent event)
  {
    try {
      ...
      while ( (line=r.readLine()) !=null ) {
        SampleData ds =
          new SampleData(line.charAt(0),AIProject2015.DOWNSAMPLE_WIDTH,AIProject2015.DOWNSAMPLE_HEIGHT);
  ...
  {
    try {
      int inputNeuron = AIProject2015.DOWNSAMPLE_HEIGHT*
        AIProject2015.DOWNSAMPLE_WIDTH;
